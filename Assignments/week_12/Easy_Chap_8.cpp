...
int main() {
    ...
    if (total_cost <= gold) {
        gold -= total_cost;
        cout << "You bought " << potions << " potions for " << total_cost 
             << " gold pieces.\n";
        cout << "You now have " << gold 
             << " gold pieces left. Safe travels, adventurer!\n";
    } else {
        cout << "You do not have enough gold to buy " << potions 
             << " potions.\n";
